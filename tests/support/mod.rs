...
pub fn work(id: &str) -> Value {
  json!({"id":id,"key":id,"kind":"ask","snapshot":"fixture","maxCalls":3,"maxInputBytes":131_072,"remaining":[],"plannedUnits":[],"pending":null,"phase":"ask","materializedChecks":true,"status":"pending","calls":0,"inputBytes":0,"totalTokens":0,"cacheHits":0,"attempts":[]})
}
