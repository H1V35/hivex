    ...
    return {
      ...
      commands: [
        ...
        },
        {
          ...
          name: "prune",
          usage:
            "prune [--root <project>] [--keep-completed <count>] [--keep-caches <count>]",
        },
        {
          modelCalls: 0,
          name: "snapshot",
      ...
      modelOptions:
        "--codex <native-binary> --deadline-ms <100..1800000> --retry-failed",
      purpose:
        "Project decisions, dependencies and exceptions for the responsible agent.",
      stage:
        "Incremental project knowledge and task/diff assistance for the principal agent.",
    };
  }
